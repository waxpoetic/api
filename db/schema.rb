...
ActiveRecord::Schema.define(version: 20161203205455) do
  ...
  create_table "subscribers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["artist_id"], name: "index_subscribers_on_artist_id", using: :btree
  end
  ...
  add_foreign_key "subscribers", "artists"
